 ...
 */int print_hexadecimal(va_list types, char buffer[],
	int flags, int width, int precision, int size)
{
	return (print_any_hexa(types, "0123456789abcdef", buffer,
...
/*
 * print_any_hexa - Prints a hexadecimal number in lower or upper
 * 
 * Return: Int(number of characters printed)
 */int print_any_hexa(va_list types, char map_to[], char buffer[],
